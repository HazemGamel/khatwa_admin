...
class _CustomDialogState extends State<CustomDialog> {
  ...
  final ridingController = TextEditingController();
  final deliveryController = TextEditingController();
  @override
  void dispose() {
    titleController.dispose();
    commissionController.dispose();
    ridingController.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    commissionController.text = widget.categoryModel?.commission.toString() ?? '0';
    ridingController.text = widget.categoryModel?.riding==true? '1':'0';
    deliveryController.text = widget.categoryModel?.delivery==true ?'1': '0';
    return Dialog(
      child: Container(
        height: 400,
